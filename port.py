...
PHOTO_URL   = "pic.jpeg"           # ← paste a direct image URL or leave empty
...
PROJECTS = [
    {
        "title":  "Indoor Acoustic Surveillance System",
        "emoji":  "🔊",
        "color":  "#FF4D6D",
        "tech":   ["Python", "PyTorch", "PyroomAcoustics", "Librosa", "NumPy", "JavaScript", "Chart.js"],
        "desc":   "Built an intelligent indoor surveillance system for sound event detection and 3D localization. Generated synthetic multi-channel datasets, implemented DSP pipeline using STFT & GCC-PHAT, and integrated real-time web visualization dashboard.",
        "impact": "Real-time Detection",
        "link":   "https://github.com/Aronjohn20/acoustic-localization",
    },
    {
        "title":  "Amazon Sales & Customer Engagement Analysis",
        "emoji":  "🛍️",
        "color":  "#00FFB2",
        "tech":   ["Python", "Pandas", "Excel", "Power BI"],
        "desc":   "Analyzed ~1,400 Amazon product records across US, India, and UK. Performed data cleaning, KPI building, and category-level analysis to identify drivers of customer engagement and sales performance.",
        "impact": "Multi-market Insights",
        "link":   "https://github.com/Aronjohn20/Amazon-Data-Analysis",
    },
    {
        "title":  "StrideWear Sales Analytics",
        "emoji":  "👟",
        "color":  "#FFD166",
        "tech":   ["Python", "Pandas", "Power BI", "Excel", "SQL"],
        "desc":   "Analyzed 100k+ global sales records across multiple regions. Built KPIs, performed time-series analysis, and created dashboards to evaluate marketing effectiveness, pricing inconsistencies, and regional trends.",
        "impact": "100k+ Records",
